...
public class GameEvent {
    ...
    public enum Type {
        ...
        SHIELD_ACTIVATED, SHIELD_BROKEN, PLAYER_DAMAGED,
        BEACON_ACTIVATED, FOG_RADIUS_CHANGED,
        ENEMY_MOVED,
        LEVEL_COMPLETE, PLAYER_DIED,
        MINI_GAME_TRIGGERED, MINI_GAME_START, EXIT_BLOCKED, EXIT_LOCKED, MINI_GAME_END,
        KEY_COLLECTED
    }
